...
/**
 * Cross-product SSO bridge, QRWegn side. Reached only via a full-page
 ...
 * ever succeeds for an email that already has a QRWegn account (from
 * this project's own signup), exactly like admin-get-magic-link.ts's
...
const FALLBACK_URL = "https://www.qrwegn.com/login";
const ALLOWED_ORIGIN = "https://www.qrwegn.com";
